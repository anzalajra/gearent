...
return [
    ...
    'database' => [
         ...
         * For PostgreSQL multi-database, we use 'pgsql' as the template.
         */
        'template_tenant_connection' => env('TENANCY_TEMPLATE_CONNECTION', 'pgsql'),
         ...
         * template0 allows setting encoding/collation, template1 does not.
         */
        'template' => 'template0',
        ...
        'managers' => [
             ...
             */
            'pgsql' => App\Services\Tenancy\PostgreSQL16DatabaseManager::class,
