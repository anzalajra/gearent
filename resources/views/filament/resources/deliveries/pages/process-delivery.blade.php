            ...
            <table class="w-full text-sm">
                <tbody>
                    <tr class="border-b border-gray-200">
                        <td class="py-3 pr-6 font-medium text-gray-500" style="width: 15%;">Delivery Number</td>
                    ...
                    <tr class="border-b border-gray-200">
                        <td class="py-3 pr-6 font-medium text-gray-500">Type</td>
                        <td class="py-3 pr-6">
                    ...
                    <tr class="border-b border-gray-200">
                        <td class="py-3 pr-6 font-medium text-gray-500">Date</td>
                    ...
                    <tr>
                        ...
                        <td class="py-3 pr-6 font-medium text-gray-500">Checked By</td>
