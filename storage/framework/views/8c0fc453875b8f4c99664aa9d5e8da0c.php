...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.actions','data' => ['actions' => $this->getCachedHeaderActions(),'class' => 'shrink-0']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/vendor/saade/filament-fullcalendar/resources/views/fullcalendar.blade.php ENDPATH**/ ?>