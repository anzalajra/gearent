                    ...
                    >
                        ...
                        >
                            ...
                            <div class="fi-fo-rich-editor-merge-tags-list">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $mergeTags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tagId => $tagLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <button
                                        draggable="true"
                                        type="button"
...
<?php endif; ?>
<?php /**PATH /var/www/vendor/filament/forms/resources/views/components/rich-editor.blade.php ENDPATH**/ ?>