...
<a class="hover:text-primary transition-colors" href="<?php echo e(route('home')); ?>#features">Features</a>
<a class="hover:text-primary transition-colors" href="<?php echo e(route('home')); ?>#solutions">Solutions</a>
<a class="text-primary font-semibold" href="<?php echo e(route('landing.pricing')); ?>">Pricing</a>
<a class="hover:text-primary transition-colors" href="<?php echo e(route('home')); ?>#testimonials">Testimonials</a>
</div>
<!-- Auth Buttons -->
